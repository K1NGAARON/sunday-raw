const usp = [
    {
        usp: 'unique-design',
        body: "Onze op maat gemaakte designs zijn uniek in de markt: We beginnen altijd met de brand guidelines van de klant (logo, Pantone-kleuren en de visie worden meegenomen). Vervolgens denken we mee over de doeleinden van de kleding en wie het zal dragen. Op die manier kan het designteam een passend design uitwerken.Het team volgt ook constant de laatste modetrends, wat ervoor zorgt dat we hippe en unieke designs ontwerpen die met trots gedragen zullen worden.",
        video: `
