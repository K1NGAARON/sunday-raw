function changeReviews() {
    const reviews = [
        ...
        {
            name: "Deel",
            review: "Sunday a joué un rôle crucial dans la rationalisation de nos opérations de marchandise. Leur approche efficace nous a non seulement fait gagner du temps, mais a également rendu l'ensemble du processus fluide et sans tracas, nous permettant de nous concentrer davantage sur notre activité principale."
        },
        {
            name: "Interstellar",
