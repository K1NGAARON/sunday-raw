...
$(document).scroll(function () {
  ...
  var exclude = $('header.product-header');
...
// LOGO SECTION
var logoTarget = document.querySelector('#logoHolder');
var logosArray = [{
  client: 'Adyen',
...
function createLogos() {
  if (logoTarget) {
    ...
    var splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__.Splide('#logoHolder', {
      arrows: false,
      drag: 'free',
      gap: '180px',
      height: '100px',
