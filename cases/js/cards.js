const content = [
    ...
    {
      client: "Deel",
      title: "Streamlining global event merchandise: How Deel and Sunday partnered to scale with precision and efficiency",
      body: "",
      logo: "",
      img: "/cases/streamlining-global-event-merch/img/banner.jpg",
      url: "/cases/streamlining-global-event-merch/",
      beachhead: "",
      companysize: "",
    },
    {
      client: "Bitpanda",
      title: "Transforming Merchandise into a Strategic Brand Asset: A Case Study of Bitpanda and Sunday's Collaboration",
      body: "",
      logo: "",
      img: "/cases/transforming-merch-into-a-strategic-brand-asset/img/banner.jpg",
      url: "/cases/transforming-merch-into-a-strategic-brand-asset/",
      beachhead: "",
      companysize: "",
    },
    {
      client: "Hubspot",
      title: "Creating connection and celebrating milestones: How HubSpot elevated employee engagement through premium merchandise",
      body: "",
      logo: "",
      img: "/cases/creating-connections-and-celebrating-milestones/img/banner.jpg",
      url: "/cases/creating-connections-and-celebrating-milestones/",
      beachhead: "",
      companysize: "",
    },
    {
      client: "Cloudflare",
      title: "Cloudflare’s strategic merchandise transformation with Sunday",
      body: "",
      logo: "",
      img: "/cases/cloudflare-strategic-merch-transformation/img/banner.jpg",
      url: "/cases/cloudflare-strategic-merch-transformation/",
      beachhead: "",
      companysize: "",
    },
    {
      client: "Rimac",
      title: "Elevating Bugatti Rimac’s brand with hyper-custom merchandise",
      body: "",
      logo: "",
      img: "/cases/elevating-bugatti-rimacs-brand-with-merch/img/banner.jpg",
      url: "/cases/elevating-bugatti-rimacs-brand-with-merch/",
      beachhead: "",
      companysize: "",
    },
    {
      client: "PGS",
      title: "PGS boosts employee engagement on autopilot in 7 countries through their internal merchandise program",
      body: "",
      logo: "",
    ...
    {
      client: "AnyDesk",
      title: "Building reseller loyalty through strategic merchandise: AnyDesk's partnership with Sunday",
      body: "",
      logo: "",
      img: "/cases/building-reseller-loyalty-through-strategic-merch/img/banner.jpg",
      url: "/cases/building-reseller-loyalty-through-strategic-merch/",
      beachhead: "",
      companysize: "",
    },
];
    ...
    if ((content.reverse(), a)) {
        ...
        .map((e) => {
          let a = e.url ? `<a href="${e.url}">` : "",
            ...
            o = e.url
              ? "video" === e.beachhead
                ? `<a class="btn dark-blue-btn" href="${e.url}">Watch the video</a>`
                : `<a class="btn dark-blue-btn" href="${e.url}">Read the case</a>`
              : "",
            n = e.logo
